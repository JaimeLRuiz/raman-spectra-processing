...
REGIONS = [
    ...
    (170, 1700, [("voigt",0.1,186,10),("voigt",0.1,266,10),("voigt", 0.1, 430, 5),("voigt", 0.1, 435, 5),("voigt", 0.2, 500, 5),("gauss",0.2,530,5),("voigt", 0.2, 535, 5),("voigt", 0.1, 580, 1),("voigt", 0.1, 660, 1),("gauss",0.5,770,5), ("voigt",0.3, 849, 2),("voigt", 0.3, 940, 2),("voigt", 0.3, 923, 2),("gauss", 0.3, 870, 10),("voigt", 0.3, 870, 2),("bwf",0.5,1600,5,-2),("gauss",0.5,1080,5),("lorentz",0.1,1400,2)]),
